...
def draw(canvas):
    global paddle1_pos, paddle2_pos, ball_pos, ball_vel, l_score, r_score, start1, start2

    if l_score == 5:
        canvas.fill(BLACK)
        myfont3 = pygame.font.SysFont("Comic Sans MS", 20)
        label3 = myfont3.render("Player 1 Won!", 1, (255, 255, 0))
        canvas.blit(label3, (150, 150))
        ...
        canvas.fill(BLACK)
        myfont3 = pygame.font.SysFont("Comic Sans MS", 20)
        label3 = myfont3.render("Player 2 Won!", 1, (255, 255, 0))
        canvas.blit(label3, (150, 150))
        pygame.display.update()
        time.sleep(5)
        conn_db.reset_db()
    ...
    elif start1 == 0 or start2 == 0:
        canvas.fill(BLACK)
        myfont4 = pygame.font.SysFont("Comic Sans MS", 20)
        label4 = myfont4.render("Waiting for players....", 1, (255, 255, 0))
        canvas.blit(label4, (150, 150))
...
while True:
    # move players
    player_mov = conn_db.get_cords_from_db()
    # move_players(player_mov)
    player1 = player_mov[0]
    player2 = player_mov[1]
    start1 = player_mov[2]
    start2 = player_mov[3]
